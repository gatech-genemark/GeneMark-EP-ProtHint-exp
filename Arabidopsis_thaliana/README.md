...
```bash
../bin/ProtHint/bin/prothint.py data/genome.fasta.masked data/phylum_excluded.fa --geneMarkGtf ES/genemark.gtf --workdir extra_runs/phylum_excluded_no_min_exon_score --maxProteinsPerSeed 25 --minExonScore -1000 > logs/phylum_excluded_no_min_exon_score_log
```
